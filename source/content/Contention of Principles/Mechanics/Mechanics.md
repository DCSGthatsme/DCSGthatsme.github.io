...
In go-time combat, your character will kick and fight, slash and stab, parry and dodge. The character does this with his or her two Actions per turn; one Combat Action and one Movement Action. The Combat Action can be replaced with an additional Movement Action, and Movement Actions can be replaced by other kinds of Actions.
